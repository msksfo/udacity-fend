...
// the span that displays the number of liks
...
const cirrus = [
    ...
    {title: 'Curious Passenger Cat', alt: 'Cirrus looking out the window while flying in a Cessna', hearts: 0},
...
select.addEventListener('change', function(e){
    ...
    let chosenImageSource = options[index].value;
